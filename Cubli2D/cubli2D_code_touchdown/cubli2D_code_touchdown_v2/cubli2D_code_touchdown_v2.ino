...
float mean = 1.0, spw = 0.0, spf = 0.0, angle = 0.0, angle_last = 0.0, angle_speed = 0.0,angle_speed2 = 0.0, ang_err = 0.0, curr = 0.0;
...
// touchdown vars
#define TD_ANGLE_START 2*3.14/180.0
#define TD_GAIN 3*10.6286
