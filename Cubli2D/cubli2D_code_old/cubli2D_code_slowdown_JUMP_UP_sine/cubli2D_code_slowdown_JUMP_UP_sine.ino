...
//Bryson's rule K values
//#define k1 -0.0004196//-0.0316       //SpeedOfWheel
//#define k2 -1.579//-15.6593      //AngleError
//#define k3 -0.1662//-0.5             //SpeedOfFrame
...
float pi = 3.14159;
float angle_sine = 0;
float A = 10*0.0174532925;
float B = 2;
boolean  start_sine  = true;
int timer_sine = 0;
int i = 0;
int j = 0;
