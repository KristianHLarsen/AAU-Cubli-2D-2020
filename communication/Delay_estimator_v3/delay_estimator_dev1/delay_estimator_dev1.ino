...
const unsigned long rx_ts = 2000;
int PacketNumber = 4;
unsigned long timer_var_rx;
int packetdelay=0;
 ...
 // flag =1;
    if (rxdelaybuffer.isEmpty() != true) { // Print 1 element from buffer.
     ...
     //packetdelay= packetdelay;
      ...
      Serial.print(tstop); Serial.print(" recieved packets: "); 
      Serial.print(rx_count);  Serial.print("Transmitted packets: "); Serial.println(tx_count);
    }
  }
